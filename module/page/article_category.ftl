		...
		<div class="aside-container" @click.stop="" ref="asideContainer">
			<div class="aside-bar">
				<div class="bar-middle" v-cloak="">
					...
					<div :class="['bar-item',{'active':showType.dmsg}]" @click="show('dmsg','https://www.dachaoka.com/directmessage')">
					...
					<div :class="['bar-item',{'active':showType.msg}]" @click="show('msg','https://www.dachaoka.com/message')">
				...
				<div class="bar-footer">
					<div class="bar-item bar-qrcode">
						...
						<div class="bar-item-desc bar-qrcode-box">
							<ul>
								<li class="b2-radius"><img :src="getQrcode('https://www.dachaoka.com/wp-jq/fenlei1')">
									<p>扫码打开当前页</p>
								</li>
								<li class="b2-radius"><img src="static/picture/code-qibier.jpg">
									<p>扫码进入公众号</p>
								</li>
								<li class="b2-radius"><img src="static/picture/code-qibier.jpg">
									<p>扫码下载APP</p>
			...
			<div class="bar-user-info" ref="asideContent" v-cloak="">
				...
				<div class="bar-box bar-mission" v-if="showType.mission && mission.data !== ''">
					<div v-cloak="">
						<div :class="['bar-user-info-row bar-mission-action',{'cur':mission.data.mission.credit === ''}]" @click="mission.mission()"
						 v-if="mission.data !== ''">
										...
										<div class="par">
											...
											<div class="coupon-date">
												<div>
													...
													<div class="coupon-desc" v-else-if="item.expiration_date.date != 0">使用时效：<p><span v-text="item.expiration_date.expired_date"></span>之前</p>
													</div>
				...
				<div class="bar-box" v-if="showType.dmsg && dmsg.count > 0">
					...
					<div class="bar-user-info-row">
						<ul v-if="dmsg.data.length > 0" class="bar-dmsg-list">
							<li v-for="item in dmsg.data" @click="jumpTo('https://www.dachaoka.com/directmessage/to/'+item.from.id)">
					...
					<div class="bar-user-info-row bar-dmsg-write">
						...
						<a href="directmessage.html">查看全部</a>
					</div>
				</div>
				<div class="bar-box" v-if="showType.user">
					<template v-if="showUser()">
						<div class="bar-user-info-row">
							<a :href="userData.link">个人中心</a>
						</div>
						<div class="bar-user-info-row">
							<div class="user-w-avatar">
							...
							<div class="user-w-name">
								<a :href="userData.link">
									<h2 v-text="userData.name"></h2><span v-html="userData.verify_icon" v-if="userData.verify"></span>
								</a>
								<div class="user-w-lv">
									<div v-html="userData.lv.vip.icon" v-if="userData.lv.vip.icon"></div>
						...
						<div class="bar-user-info-row">
							<div class="bar-user-info-row-title"><a href="verify.html"><span>认证</span><span>❯</span></a></div>
							<div class="user-w-rw">
						...
						<div class="bar-user-info-row">
							<div class="bar-user-info-row-title"><a href="task.html"><span>任务</span><span>❯</span></a></div>
							<div class="user-w-rw">
						...
						<div class="bar-user-info-row">
							<div class="bar-user-info-row-title"><a href="gold.html"><span>升级</span><span>❯</span></a></div>
							<div class="user-w-rw">
								<div class="bar-user-next-lv">
						...
						<div class="bar-user-info-row">
							<div class="bar-user-info-row-title"><a href="gold.html"><span>财富</span><span>❯</span></a></div>
							<div class="user-w-gold">
								<div class="user-money"><a href="gold.html"><span>￥</span><b>余额：{{userData.money}}</b></a></div>
								<div class="user-credit"><a href="gold.html"><span><i class="b2font b2-jifen "></i></span><b>积分：{{userData.credit}}</b></a></div>
							</div>
						</div>
					</template>
				</div>
